...
const flujoConsulta = addKeyword(['hola', 'buenas', 'consulta', 'Hola'])
    ...
    .addAnswer(
        '¿Cuál es el nombre del detenido (en caso de que no aplique, poner .)?',
        { capture: true },
        (ctx) => {
            userData.person_name = ctx.body; // Guarda el nombre del usuario
        }
    )
    .addAnswer(
        '¿Cuál es el apellido del detenido (en caso de que no aplique, poner .)?',
        { capture: true },
        (ctx) => {
            userData.person_last_name = ctx.body; // Guarda el nombre del usuario
        }
    )
    .addAnswer(
        '¿Cuál es la placa del vehículo (en caso de que no aplique, poner .)?',
        { capture: true },
        (ctx) => {
    ...
    .addAnswer(
        '¿Cuál es el número de serie del vehículo (en caso de que no aplique, poner .)?',
        { capture: true },
        async (ctx, { endFlow }) => {
